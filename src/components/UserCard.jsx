  ...
  return (
    <div className="relative w-full max-w-[280px] md:max-w-[320px] lg:max-w-[300px] xl:max-w-[340px]">
      ...
      <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 flex gap-3 z-50">
        <button className="p-3 bg-red-500 rounded-full shadow-lg hover:bg-red-600 transition-all transform hover:scale-110">
          <svg
        ...
        <button className="p-3 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all transform hover:scale-110">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 text-white"
            fill="none"
